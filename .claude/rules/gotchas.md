...
| Jellyfin SLO → re-login "no authorization in progress" | Sau SLO, re-login Jellyfin trực tiếp → OAuth2 callback fail. Có thể pre-existing, chưa investigate root cause. Stack A/C không bị | Cần investigate trước khi re-implement FIX-09 |
