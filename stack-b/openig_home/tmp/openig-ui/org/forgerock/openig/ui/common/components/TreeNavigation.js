...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/util/ModuleLoader", "org/forgerock/commons/ui/common/util/URIUtils"], function ($, _, AbstractView, ModuleLoader, URIUtils) {
    var TreeNavigation = AbstractView.extend({
        template: "templates/openig/admin/common/navigation/TreeNavigationTemplate.html",
        partials: ["templates/openig/admin/routes/RouteTopBar.html", "templates/openig/admin/common/navigation/_TreeNavigationLeaf.html"],
        events: {
        ...
        render: function render(args, callback) {
            ...
            this.parentRender(function () {
                ...
                if (!this.nextRenderPage) {
                    ModuleLoader.load(this.route.page).then(function (page) {
        ...
        renderPage: function renderPage(Module, args, callback) {
            var page = new Module({ parentData: this.data });
