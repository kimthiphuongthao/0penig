...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/Configuration"], function ($, _, constants, conf) {
    var themePromise = void 0;

    return {
        loadThemeCSS: function loadThemeCSS(theme) {
        ...
        loadThemeConfig: function loadThemeConfig() {
            var prom = $.Deferred();
        ...
        getTheme: function getTheme() {
            ...
            if (themePromise === undefined) {
                themePromise = this.loadThemeConfig().then(function (themeConfig) {
                    conf.globalData.theme = themeConfig;
                    _this.loadThemeCSS(themeConfig);
                    return themeConfig;
                });
            }
            return themePromise;
