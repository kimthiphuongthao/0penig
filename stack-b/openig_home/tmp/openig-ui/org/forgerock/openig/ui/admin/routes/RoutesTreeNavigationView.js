...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/openig/ui/common/components/TreeNavigation", "org/forgerock/openig/ui/admin/views/common/navigation/createTreeNavigation", "org/forgerock/openig/ui/admin/models/RoutesCollection", "org/forgerock/openig/ui/admin/models/ServerRoutesCollection", "org/forgerock/openig/ui/admin/util/RoutesUtils"], function ($, _, Constants, EventManager, Router, TreeNavigation, createTreeNavigation, RoutesCollection, ServerRoutesCollection, RoutesUtils) {
    var navData = [{
    ...
    var RoutesTreeNavigationView = TreeNavigation.extend({
        events: {
        ...
        render: function render(args, callback) {
            ...
            RoutesCollection.byRouteId(this.data.routePath).then(_.bind(function (routeData) {
                if (!routeData) {
                    ...
                    EventManager.sendEvent(Constants.EVENT_CHANGE_VIEW, { route: Router.configuration.routes.listRoutesView });
                    return;
                }
                ...
                this.data.treeNavigation = createTreeNavigation(navData, [encodeURIComponent(this.data.routePath)]);
                this.data.title = routeData.get("name");
                this.data.home = "#" + Router.getLink(Router.configuration.routes.routeOverview, [encodeURIComponent(this.data.routePath)]);

                TreeNavigation.prototype.render.call(this, args, callback);
            }, this));
        },
        exportRouteConfig: function exportRouteConfig(e) {
            e.preventDefault();
            RoutesUtils.exportRouteConfigDialog(this.data.routeName, this.data.title);
        },
        duplicateRoute: function duplicateRoute(e) {
            e.preventDefault();
            RoutesUtils.duplicateRouteDialog(this.data.routeName, this.data.title);
        },
        deployRoute: function deployRoute(e) {
            e.preventDefault();
            RoutesUtils.deployRouteDialog(this.data.routeName, this.data.title);
        },
        undeployRoute: function undeployRoute(e) {
            e.preventDefault();
            RoutesUtils.undeployRouteDialog(this.data.routeName, this.data.title);
        },
        deleteRoute: function deleteRoute(e) {
            e.preventDefault();
            RoutesUtils.deleteRouteDialog(this.data.routeName, this.data.title).then(function () {
                EventManager.sendEvent(Constants.EVENT_CHANGE_VIEW, { route: Router.configuration.routes.listRoutesView });
            });
        }
    });
...
//# sourceMappingURL=RoutesTreeNavigationView.js.map
