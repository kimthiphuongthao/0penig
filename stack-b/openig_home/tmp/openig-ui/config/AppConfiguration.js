...
define([], function () {
    return {
        moduleDefinition: [{
            ...
            configuration: {
                processConfigurationFiles: ["config/process/OpenIGConfig", "config/process/CommonConfig"]
            }
        }, {
            moduleClass: "org/forgerock/commons/ui/common/main/Router",
            configuration: {
                routes: {},
                loader: [{ "routes": "config/routes/OpenIGRoutesConfig" }]
            }
        }, {
            ...
            configuration: {
                messages: {},
                loader: [{ "messages": "config/messages/CommonMessages" }, { "messages": "config/messages/OpenIGMessages" }]
            }
        }, {
            moduleClass: "org/forgerock/commons/ui/common/main/ValidatorsManager",
            configuration: {
                validators: {},
                loader: [{ "validators": "config/validators/CommonValidators" }, { "validators": "config/validators/OpenIGValidators" }]
            }
        }],
        loggerLevel: "debug"
    };
