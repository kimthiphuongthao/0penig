...
def resolveSid = {
    ...
    def publicUrl = System.getenv('OPENIG_PUBLIC_URL') ?: 'http://openiga.sso.local:80'; def idToken = session['oauth2:' + publicUrl + '/openid/app1']?.get('atr')?.get('id_token') as String
